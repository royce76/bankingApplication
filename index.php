...
<?php if (sizeof(array_diff($connexion, $ID)) === 0): ?>
...
<?php else: echo '<p class="text-center">Regardez en haut de la page à droite pour vous connecter et afficher vos comptes</p>';?>  
<?php endif; ?>
